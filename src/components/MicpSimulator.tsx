...
const translations: Array<[string, string]> = [
  ...
  ["(MICP) — where ", "」（MICP）——"],
  [" bacteria trigger biochemical reactions that produce calcite crystals, autonomously sealing cracks and restoring structural integrity.", "芽孢桿菌觸發生化反應，生成方解石晶體。系統可精確封閉達 0.97mm 的裂縫，癒合效率高達 65.5% 以上。」"],
  ...
  ["Crack", "裂縫"],
  ["Microcrack initiation at ITZ & propagation", "微裂縫從 ITZ（界面過渡區）開始形成並延伸"],
  ["H₂O + O₂", "H₂O + O₂"],
  ...
  ["Basilisk Technology Line", "Basilisk 技術產品線"],
  ["Healing Agent (New structures)", "自癒添加劑（新建築施工）"],
  ["ER7 Liquid System (Existing)", "ER7 液態修復系統（既有結構）"],
  ["MR3 Repair Mortar (Repair)", "MR3 自癒修復砂漿（結構修補）"],
  ...
  ["Autonomous repair eliminates expensive manual interventions, reducing maintenance costs by up to 40-50%.", "自主修復可減少昂貴的人工維修，最高可降低 40-50% 的維護成本。"],
  ["Extended Lifespan", "強度恢復與壽命延長"],
  ["Self-healing extends concrete structure lifespan by 15+ years, improving infrastructure resilience.", "研究證實自癒過程可使抗壓強度恢復達 42.8%，並延長結構壽命 15 年以上，提升基礎設施韌性。"],
  ["About", "關於研究"],
